...
--        first_name->>'first_name_ru' as first_name_ru,
       ...
       unemployed_reg,
       unemployed_reg_refresh_date
FROM crm360_person where iin =$1`
...
type Person struct {
	...
	IIN                          *string          `json:"iin" db:"iin" uri:"iin"  binding:"required,min=1,max=12"`
	RNN                          *string          `json:"rnn" db:"rnn"`
	BirthDate                    *util.CustomDate `json:"birth_date" db:"birth_date"`
	DeathDate                    *util.CustomDate `json:"death_date" db:"death_date"`
	...
	PortalRefreshDate            *util.CustomDate `json:"portal_refresh_date" db:"portal_refresh_date"`
	...
	UnemployedRegRefreshDate     *util.CustomDate `json:"unemployed_reg_refresh_date" db:"unemployed_reg_refresh_date"`
}
...
type NewPerson struct {
	...
	IIN                          *string                      `json:"iin" db:"iin" binding:"required,min=1,max=12"`
	RNN                          *string                      `json:"rnn" db:"rnn"`
	BirthDate                    *util.CustomDate             `json:"birth_date" db:"birth_date"`
	DeathDate                    *util.CustomDate             `json:"death_date" db:"death_date"`
	Resident                     *string                      `json:"resident" db:"resident"`
...
type accident struct {
	...
	AccidentDate       *util.CustomDate `json:"accident_date"`
	AccidentDamageType *string          `json:"accident_damage_type"`
}

type asp struct {
	AspAmount               *float64         `json:"asp_amount"`
	AspDateFrom             *util.CustomDate `json:"asp_date_from"`
	AspDateTo               *util.CustomDate `json:"asp_date_to"`
...
type esp struct {
	...
	EspPaymentDate   *util.CustomDate `json:"esp_payment_date"`
}

type avgIncome struct {
	AvgIncomeAmount          *float64         `json:"avg_income_amount"`
	AvgIncomePeriod          *util.CustomDate `json:"avg_income_period"`
	...
	AvgIncomeRefreshDate     *util.CustomDate `json:"avg_income_refresh_date"`
}

type avgPensionIncome struct {
	AvgPensionIncomeAmount         *float64         `json:"avg_pension_income_amount"`
	AvgPensionIncomePeriod         *util.CustomDate `json:"avg_pension_income_period"`
...
type avgSocialIncome struct {
	...
	AvgSocialPeriod       *util.CustomDate `json:"avg_social_income_period"`
...
type education struct {
	...
	EducationDateFrom            util.CustomDate          `json:"education_date_from_from"`
	EducationDateTo              util.CustomDate          `json:"education_date_to"`
...
type pcrTest struct {
	...
	PcrTestProtocolDate       *util.CustomDate `json:"pcr_test_protocol_date"`
...
type farmAnimal struct {
	...
	FarmAnimalRefreshDate     *util.CustomDate `json:"farm_animal_refresh_date"`
}
...
type bmlPdlScoring struct {
	...
	BmlPdlScoringDate               *util.CustomDate `json:"bml_pdl_scoring_date"`
}
...
type asiaCreditBankScoring struct {
	...
	AsiaCreditBankScoringDate           *util.CustomDate `json:"asia_credit_bank_scoring_date"`
}

type alfaBankScoring struct {
	AlfaBankScoringScore *int64           `json:"alfa_bank_scoring_score"`
	AlfaBankScoringDate  *util.CustomDate `json:"alfa_bank_scoring_date"`
}

type behaviorScoring struct {
	BehaviorScoringDate                           *util.CustomDate `json:"behavior_scoring_date"`
...
type bckBankScoring struct {
	BckBankScoringDate                                  *util.CustomDate `json:"bck_bank_scoring_date"`
...
type applicationScoring struct {
	ApplicationScoringDate         *util.CustomDate `json:"application_scoring_date"`
...
type ficoScoring struct {
	FicoScoringDate  *util.CustomDate `json:"fico_scoring_date"`
...
type fraudScoring struct {
	...
	FraudScoringDate        *util.CustomDate `json:"fraud_scoring_date"`
}

type fastCashScoring struct {
	FastCashScoringDate                  *util.CustomDate `json:"fast_cash_scoring_date"`
...
type freedomFinanceBankScoring struct {
	FreedomFinanceBankScoringDate                                *util.CustomDate `json:"freedom_finance_bank_scoring_date"`
...
type forteBankScoring struct {
	ForteBankScoringDate                 *util.CustomDate `json:"forte_bank_scoring_date"`
...
type jysanBankScoring struct {
	JysanBankScoringDate                                      *util.CustomDate `json:"jysan_bank_scoring_date"`
...
type kaspiBankScoring struct {
	...
	KaspiBankScoringDate                                      *util.CustomDate `json:"kaspi_bank_scoring_date"`
...
type quantumScoring struct {
	QuantumScoringDate               *util.CustomDate `json:"quantum_scoring_date"`
...
type sberbankScoring struct {
	SberbankScoringDate                                *util.CustomDate `json:"sberbank_scoring_date"`
...
type vtbScoring struct {
	VtbScoringDate                                     *util.CustomDate `json:"vtb_scoring_date"`
...
type creditRatingScoring struct {
	...
	CreditRatingScoringDate      *util.CustomDate `json:"credit_rating_scoring_date"`
...
type financingTerrExtrList struct {
	...
	FinancingTerrExtrListIncludeDate *util.CustomDate `json:"financing_terr_extr_list_include_date"`
	FinancingTerrExtrListExcludeDate *util.CustomDate `json:"financing_terr_extr_list_exclude_date"`
}

type opv struct {
	OpvAmount        *float64         `json:"opv_amount"`
	OpvPeriod        *util.CustomDate `json:"opv_period"`
...
type income struct {
	...
	IncomePaymentDate   *util.CustomDate `json:"income_payment_date"`
	IncomePeriod        *util.CustomDate `json:"income_period"`
	IncomeCompanyIinBin *string          `json:"income_company_iin_bin"`
	IncomeRefreshDate   *util.CustomDate `json:"income_refresh_date"`
}

type jobContract struct {
	JobContractDate          *util.CustomDate `json:"job_contract_date"`
	JobContractDateFrom      *util.CustomDate `json:"job_contract_date_from"`
	JobContractDateTo        *util.CustomDate `json:"job_contract_date_to"`
	...
	JobContractRefreshDate              *util.CustomDate `json:"job_contract_refresh_date"`
...
type jobHead struct {
	...
	JobHeadRefreshDate   *util.CustomDate `json:"job_head_refresh_date"`
}
...
type incomeRefund struct {
	...
	IncomeRefundDate         *util.CustomDate `json:"income_refund_date"`
	IncomeRefundRefundPeriod *util.CustomDate `json:"income_refund_refund_period"`
}

type criminalRecord struct { //Нет привязки к БТ
	CriminalRecordRefreshDate               *util.CustomDate `json:"criminal_record_refresh_date"`
	...
	CriminalRecordCondemnationDate          *util.CustomDate `json:"criminal_record_condemnation_date"`
	...
	CriminalRecordSentenceDateFrom          *util.CustomDate `json:"criminal_record_sentence_date_from"`
	CriminalRecordPunishmentTermDateFrom    *util.CustomDate `json:"criminal_record_punishment_term_date_from"`
	CriminalRecordReleaseDate               *util.CustomDate `json:"criminal_record_release_date"`
	...
	CriminalRecordGrantOfParoleFactDateFrom *util.CustomDate `json:"criminal_record_grant_of_parole_fact_date_from"`
	...
	CriminalRecordDateOfArrest              *util.CustomDate `json:"criminal_record_date_of_arrest"`
	CriminalRecordCaseNumber                *string          `json:"criminal_record_case_number"`
	CriminalRecordCaseDateFrom              *util.CustomDate `json:"criminal_record_case_date_from"`
...
type kdn struct {
	...
	KdnRefreshDate  *util.CustomDate `json:"kdn_refresh_date"`
...
type taxNotification struct {
	...
	TaxNotificationDate       *util.CustomDate `json:"tax_notification_date"`
	TaxNotificationReturnDate *util.CustomDate `json:"tax_notification_return_date"`
...
type narcoRegistry struct {
	...
	NarcoRegistryRefreshDate  *util.CustomDate `json:"narco_registry_refresh_date"`
}

type photo struct {
	PhotoRefreshDate *util.CustomDate `json:"photo_refresh_date"`
	PhotoLocation    *string          `json:"photo_location"`
}

type bmg struct {
	BmgMobileNumber *string          `json:"bmg_mobile_number"`
	BmgRefreshDate  *util.CustomDate `json:"bmg_refresh_date"`
}
...
type psychoRegistry struct {
	...
	PsychoRegistryRefreshDate  *util.CustomDate `json:"psycho_registry_refresh_date"`
}
...
type registrationAddress struct {
	...
	RegistrationAddressRefreshDate    *util.CustomDate `json:"registration_address_refresh_date"`
...
type tubRegistry struct {
	...
	TubRegistryRefreshDate  *util.CustomDate `json:"tub_registry_refresh_date"`
}

type vaccinationKz struct {
	VaccinationKzPatientIIN            *string          `json:"vaccination_kz_patient_iin"`
	VaccinationKzPatientDateOfBirth    *util.CustomDate `json:"vaccination_kz_patient_date_of_birth"`
	...
	VaccinationKzValidDate             *util.CustomDate `json:"vaccination_kz_valid_date"`
	VaccinationKzRevacSeries           *string          `json:"vaccination_kz_revac_series"`
	VaccinationKzRevacDate             *util.CustomDate `json:"vaccination_kz_revac_date"`
...
type realEstateObjectRegistration struct {
	...
	RealEstateObjectRegistrationDateFrom                *util.CustomDate `json:"real_estate_object_registration_date_from"`
	RealEstateObjectRegistrationDateTo                  *util.CustomDate `json:"real_estate_object_registration_date_to"`
	RealEstateObjectRegistrationRefreshDate             *util.CustomDate `json:"real_estate_object_registration_refresh_date"`
...
type wantedChildEnforcement struct {
	...
	WantedChildEnforcementDossierCreationDate *util.CustomDate `json:"wanted_child_enforcement_dossier_creation_date"`
...
type wantedDebtor struct {
	...
	WantedDebtorDossierCreationDate *util.CustomDate `json:"wanted_debtor_dossier_creation_date"`
...
type wantedDefendant struct {
	...
	WantedDefendantDossierCreationDate *util.CustomDate `json:"wanted_defendant_dossier_creation_date"`
...
type wantedForViolation struct {
	...
	WantedForViolationDossierCreationDate *util.CustomDate `json:"wanted_for_violation_dossier_creation_date"`
...
type wantedGovDebtor struct {
	...
	WantedGovDebtorDossierCreationDate *util.CustomDate `json:"wanted_gov_debtor_dossier_creation_date"`
...
type wantedLost struct {
	...
	WantedLostDossierCreationDate *util.CustomDate `json:"wanted_lost_dossier_creation_date"`
...
type realEstateQueue struct {
	RealEstateQueueDate            *util.CustomDate `json:"real_estate_queue_date"`
...
type realEstateObjectEncumbrance struct {
	...
	RealEstateObjectEncumbranceDateFrom     *util.CustomDate `json:"real_estate_object_encumbrance_date_from"`
	RealEstateObjectEncumbranceDateTo       *util.CustomDate `json:"real_estate_object_encumbrance_date_to"`
	RealEstateObjectEncumbranceRefreshDate  *util.CustomDate `json:"real_estate_object_encumbrance_refresh_date"`
...
type bankruptcyApplication struct {
	...
	BankruptcyApplicationDate                     util.CustomDate           `json:"bankruptcy_application_date"`
	BankruptcyApplicationRefusalDate              util.CustomDate           `json:"bankruptcy_application_refusal_date"`
	...
	BankruptcyApplicationProceedingsStartDate     util.CustomDate           `json:"bankruptcy_application_proceedings_start_date"`
	BankruptcyApplicationStatementAcceptDate      util.CustomDate           `json:"bankruptcy_application_statement_accept_date"`
	BankruptcyApplicationCourtDecisionDate        util.CustomDate           `json:"bankruptcy_application_court_decision_date"`
	BankruptcyApplicationTerminationDate          util.CustomDate           `json:"bankruptcy_application_termination_date"`
	...
	BankruptcyApplicationBankruptStartDate        util.CustomDate           `json:"bankruptcy_application_bankrupt_start_date"`
	BankruptcyApplicationBankruptEndDate          util.CustomDate           `json:"bankruptcy_application_bankrupt_end_date"`
	...
	BankruptcyApplicationRefreshDate              util.CustomDate           `json:"bankruptcy_application_refresh_date"`
